    ...
    >
      ...
      >
        {showRole && (
          <span
            className={cn(
              "pointer-events-none absolute top-3 max-w-[46%] text-[11px] font-black uppercase leading-tight tracking-[0.18em]",
 ...
 * Role labels render as plain corner text; avatar + gamertag stay centered.
 */
export function JMTournamentVs({
  ...
  return (
    <div className={cn("flex min-h-0 flex-1 flex-col px-3 py-3 sm:px-4", className)}>
      {showTopRow && (
