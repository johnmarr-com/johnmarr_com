    ...
    <div className="flex h-dvh items-center justify-center overflow-hidden bg-black p-[40px]">
      ...
      >
        ...
        <Link
          ...
          className="absolute right-[35px] top-[25px] z-10 rounded-full px-5 py-2 font-medium text-white transition-all duration-300 hover:scale-110 hover:bg-white/60 hover:text-black hover:font-bold"
          style={{
        ...
        >
          ...
          >
            {/* Logo: anchored 30px above the button, 20% wider, centered */}
            <div
              className="animate-gentle-float absolute"
              style={{
            ...
            >
              <Image
                src="/images/logos/Landing-Page-Logo.png"
                alt="John Marr"
                width={400}
                height={200}
