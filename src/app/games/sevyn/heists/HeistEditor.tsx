...
import { HEIST_ELEMENT_LABELS } from "../sevynTypes";
...
import { uploadSevynAudio } from "@/lib/sevyn-storage";
...
export default function HeistEditor({ editHeist }: HeistEditorProps = {}) {
  ...
  const downloadSampleJson = useCallback(() => {
    ...
    a.href = url;
    a.download = "sevyn-heist-sample.json";
    a.click();
          ...
          <div className="relative z-10 w-full max-w-sm rounded-t-2xl border border-red-600/20 bg-neutral-950 p-5 shadow-2xl sm:rounded-2xl">
            ...
            <JMAudioUpload
              ...
              onUpload={async (file) => {
                ...
                return uploadSevynAudio(heistId, soundUploadForElement, file);
              }}
              maxSizeMB={5}
            />
          </div>
