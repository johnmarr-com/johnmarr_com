...
export const AZV_LAYOUT = {
  ...
  /** Weapon type badge — 175×175 centered at (220, 1010); shares the hits
   * slot's top edge (types with a weapon never carry hits). Only Good Stuff
   * weapons and Mega Stuff carry one. */
  weaponBadge: { cx: 220, cy: 1010, size: 175 },
