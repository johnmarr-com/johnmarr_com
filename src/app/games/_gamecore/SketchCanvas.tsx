      ...
      <div className={`flex flex-col items-center gap-2 ${className}`}>
        ...
        <div className="flex w-full items-center justify-between" style={{ maxWidth: CANVAS_SIZE }}>
          <button
            ...
            className="flex items-center gap-1 rounded-lg border border-white/20 bg-white/5 px-2.5 py-1.5 text-[10px] font-bold uppercase tracking-wider text-white/50 transition-colors hover:bg-white/10"
          >
          ...
          <button
            ...
            className="flex items-center gap-1 rounded-lg border border-red-400/20 bg-red-400/5 px-2.5 py-1.5 text-[10px] font-bold uppercase tracking-wider text-red-400/50 transition-colors hover:bg-red-400/10"
          >
        ...
        {!readOnly && (
          <div className="flex items-center justify-center gap-1.5">
            ...
            <button
              ...
              className={`ml-1 flex h-8 w-8 items-center justify-center rounded-full border-2 transition-all ${
                eraseMode
                  ? "scale-110 border-white bg-white text-black shadow-lg"
                  : "border-white/20 bg-white/10 text-white/50 hover:scale-105 hover:bg-white/20"
              }`}
              aria-label="Eraser"
            >
